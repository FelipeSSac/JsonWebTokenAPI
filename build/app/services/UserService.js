...
var UserService = /** @class */ (function () {
    function UserService() {
        this.userRepository = typeorm_1.getRepository(User_1.default);
    }
    ...
    UserService.prototype.list = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepository.find({ where: { 'is_deleted': false } })];
                    case 1:
                        users = _a.sent();
    ...
    UserService.prototype.update = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.userRepository.findOne({ where: { email: email, 'is_deleted': false } })];
                    case 1:
                        user = _b.sent();
                        if (!user) {
                    ...
                    case 2:
                        ...
                        this.userRepository.merge(user, { email: email, password: password });
                        return [4 /*yield*/, this.userRepository.save(user)];
                    case 3:
                        _b.sent();
                        delete user.password;
